...
with st.container():
    ...
    if language == "English":
        possible_questions = [
            ...
            "For customer with id 7, how is the total daily usage distributed across all devices in the past 5 days?",
        ...
        possible_questions = [
            ...
            "Untuk pelanggan dengan id 7, bagaimana distribusi penggunaan total daya harian di semua perangkat untuk 5 hari terakhir?",
