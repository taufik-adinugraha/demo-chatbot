...
######################################################## Initialization
# System instructions
def get_system_instructions(table_schemas: str, response_type: str, number_of_sections: int, language: str):
...
async def api_chat(request: ChatRequest):
    # Initialize messages
    system_prompt = get_system_instructions(table_schemas, request.response_type, request.number_of_sections, request.language)
